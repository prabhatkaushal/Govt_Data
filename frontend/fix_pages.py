...
os.makedirs('frontend/src/app/cases/[id]', exist_ok=True)
with open('frontend/src/app/cases/[id]/page.tsx', 'w') as f:
    f.write(cases_id_page)

os.makedirs('frontend/src/app/documents/[id]', exist_ok=True)
with open('frontend/src/app/documents/[id]/page.tsx', 'w') as f:
    f.write(documents_id_page)
