...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        users = [
            User(username="26000000", employee_id="EMP001", full_name="Super Admin", email="admin@nyayavault.gov", password=make_password("gov123"), role=RoleEnum.SUPER_ADMIN),
            User(username="26010001", employee_id="EMP002", full_name="Inspector Rahul Sharma", email="investigator@nyayavault.gov", password=make_password("gov123"), role=RoleEnum.INVESTIGATING_OFFICER, department=depts[0]),
            User(username="26010002", employee_id="EMP003", full_name="Dr. Anita Mehta", email="forensic@nyayavault.gov", password=make_password("gov123"), role=RoleEnum.FORENSIC_OFFICER, department=depts[2]),
            User(username="26010003", employee_id="EMP004", full_name="Advocate Priya Patel", email="legal@nyayavault.gov", password=make_password("gov123"), role=RoleEnum.LEGAL_OFFICER, department=depts[3]),
            User(username="26010004", employee_id="EMP005", full_name="Auditor Verma", email="auditor@nyayavault.gov", password=make_password("gov123"), role=RoleEnum.AUDITOR),
        ]
